...
const TECH_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'API Routes',
        description: 'Proxy CORS para comunicação segura com provedores de IA',
      },
    ],
  },
];
...
const NAV_ITEMS = [
  { href: '#como-funciona', label: 'Como Funciona', icon: <Cpu size={14} aria-hidden="true" /> },
  { href: '#tecnologias', label: 'Tecnologias', icon: <Layers size={14} aria-hidden="true" /> },
  { href: '#desenvolvedores', label: 'Para Desenvolvedores', icon: <Code2 size={14} aria-hidden="true" /> },
];
  ...
  return (
    <div className="flex flex-col items-center sm:flex-row sm:items-start gap-0 sm:gap-0">
      ...
      <div className="relative flex flex-col items-center text-center w-full max-w-[180px] sm:max-w-[160px] lg:max-w-[180px]">
        ...
        <h4 className="text-sm font-semibold text-[#e4e4e7] mb-1">{step.title}</h4>
        <p className="text-[11px] sm:text-xs text-[#9ca3af] leading-relaxed">{step.description}</p>
      </div>
      ...
      {!isLast && (
        <>
          ...
          <div className="hidden sm:flex items-center px-2 lg:px-3 pt-6 shrink-0">
            ...
            <ArrowRight size={14} className="text-[#00ffd5]/50 -ml-1" aria-hidden="true" />
          </div>
          ...
          <div className="flex sm:hidden flex-col items-center py-2 shrink-0">
            ...
            <ArrowRight
              size={14}
              className="text-[#00ffd5]/50 rotate-90 -mt-1"
              aria-hidden="true"
            />
          </div>
        </>
...
export default function DocumentacaoPage() {
      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center h-12 w-12 rounded-xl bg-[#00ffd5]/10 border border-[#00ffd5]/20 mb-4">
            <BookOpen size={22} className="text-[#00ffd5]" aria-hidden="true" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-bold text-[#e4e4e7] mb-2">Documentação</h1>
        ...
        <div className="space-y-8 sm:space-y-12">
          ...
          <section id="como-funciona" className="scroll-mt-24">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-[#e4e4e7]">Como Funciona</h2>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-5">
                <h4 className="text-sm font-semibold text-[#00ffd5] mb-2">Extração de texto</h4>
                <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                  O PDF é processado inteiramente no seu navegador usando pdfjs-dist. A extração
                  detecta automaticamente layouts multi-coluna e reordena o texto em ordem natural
                  de leitura, evitando que currículos em duas colunas fiquem embaralhados. Em
                  seguida, o texto passa por uma normalização que unifica bullets, corrige
                  hifenização de fim de linha e remove caracteres invisíveis. Quando o PDF é
                  escaneado, o sistema ativa o OCR via Tesseract.js e informa a confiança média por
                  página. Você pode revisar e corrigir o texto extraído antes de analisar. Tudo fica
                  no seu navegador.
                </p>
              </div>

              <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-5">
                <h4 className="text-sm font-semibold text-[#00ffd5] mb-2">Pré-processamento NLP</h4>
                <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                  Antes de enviar o texto para a IA, o sistema aplica TF-IDF para extrair os termos
                  mais relevantes do currículo e da vaga. Isso reduz o número de tokens enviados,
                  diminuindo o custo da análise e melhorando a precisão dos resultados. Os
                  resultados dessa pré-análise são exibidos ao usuário como um "Raio-X de
              ...
              <div className="rounded-xl border border-white/[0.06] bg-[#141420] p-5 sm:col-span-2 lg:col-span-1">
                <h4 className="text-sm font-semibold text-[#00ffd5] mb-2">Análise com IA</h4>
                <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                  O texto otimizado é enviado ao provedor de IA escolhido (OpenAI, Anthropic ou
                  Google) via proxy CORS do Next.js. A IA retorna um relatório estruturado com score
                  de aderência, habilidades, lacunas, palavras-chave e plano de estudos. Para cada
                  lacuna identificada, a IA também sugere como reescrever trechos do currículo para
                  incorporar os termos faltantes. Cada sugestão tem botão de cópia com feedback
                  visual para você aplicar no seu currículo em um clique. O usuário pode
                  opcionalmente salvar cada análise num histórico local (até 10 entradas) ativando o
                  toggle em Configurações. O histórico fica inteiramente no navegador.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 rounded-xl border border-[#00ffd5]/15 bg-[#00ffd5]/[0.04] p-4 sm:p-5">
              <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                <strong className="text-[#e4e4e7]">Quer ver tudo isso em ação?</strong> A rota{' '}
                <a href="/demo" className="text-[#00ffd5] hover:underline">
                  /demo
                </a>{' '}
                mostra três análises completas pré-geradas (analista de dados, segurança e dev full
                stack) sem precisar de cadastro ou API key.
              </p>
            </div>
          </section>
          ...
          <section id="tecnologias" className="scroll-mt-24">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-[#e4e4e7]">Tecnologias</h2>
            </div>
              ...
              {TECH_CATEGORIES.map((cat) => (
                <div key={cat.category}>
                  ...
                  <div className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-3">
                    {cat.items.map((item) => (
                      <TechCard key={item.name} name={item.name} description={item.description} />
                    ))}
                  </div>
                </div>
              ))}
          ...
          <section id="desenvolvedores" className="scroll-mt-24">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-[#e4e4e7]">Para Desenvolvedores</h2>
            </div>
              ...
              <details className="group rounded-2xl border border-white/[0.06] bg-[#141420] overflow-hidden">
                <summary className="flex items-center justify-between cursor-pointer px-5 py-4 text-sm font-semibold text-[#e4e4e7] hover:text-white transition-colors list-none [&::-webkit-details-marker]:hidden">
                  <span className="flex items-center gap-2.5">
                    <FolderTree size={15} className="text-[#00ffd5]" aria-hidden="true" />
  ...
  types/              # Definições de tipos TypeScript`}</code>
              ...
              <details className="group rounded-2xl border border-white/[0.06] bg-[#141420] overflow-hidden">
                <summary className="flex items-center justify-between cursor-pointer px-5 py-4 text-sm font-semibold text-[#e4e4e7] hover:text-white transition-colors list-none [&::-webkit-details-marker]:hidden">
                  <span className="flex items-center gap-2.5">
                    <Sparkles size={15} className="text-[#00ffd5]" aria-hidden="true" />
                ...
                <div className="px-5 pb-5 border-t border-white/[0.04] pt-4 space-y-2.5">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-2.5 text-[13px] text-[#9ca3af]">
              ...
              <details className="group rounded-2xl border border-white/[0.06] bg-[#141420] overflow-hidden">
                <summary className="flex items-center justify-between cursor-pointer px-5 py-4 text-sm font-semibold text-[#e4e4e7] hover:text-white transition-colors list-none [&::-webkit-details-marker]:hidden">
                  <span className="flex items-center gap-2.5">
                    <GitBranch size={15} className="text-[#00ffd5]" aria-hidden="true" />
                  ...
                  <div className="grid gap-1.5 text-[13px]">
                    {[
                      ...
                      <div key={prefix} className="flex gap-2">
                        <code className="text-[#00ffd5] font-mono w-24 shrink-0">{prefix}</code>
